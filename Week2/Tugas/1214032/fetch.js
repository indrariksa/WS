...
fetch("https://digimon-api.vercel.app/api/digimon", requestOptions)
  ...
  function tampilkan(result){
    ...
    for(i=0; i<Length; i++)
    {
      ...
      hasil += "<td scope='col' class='px-6 py-4 font-medium text-gray-900'>"+iniJson[i].level+"</td>";
      hasil += "<td scope='col' class='px-6 py-4 font-medium text-gray-900 text-center'><img src='"+iniJson[i].img+"'/></td>";
      hasil += "<td scope='col' class='px-6 py-4 font-medium text-gray-900'>"+iniJson[i].level+"</td>";
      hasil += "</tr>";
    }
